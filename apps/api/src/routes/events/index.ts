  ...
  .route(
    ...
    new Hono()
      ...
      .get(async (c) => {
        ...
        const [existingRegistration] = await db
          ...
          .leftJoin(
            ...
            and(
              ...
              eq(eventRegistrations.userId, user?.id ?? null),
            ),
          );
        ...
        if (!user && !isRegistrationClosed) {
          return c.json({ status: "NOT_AUTHENTICATED", eventRegistrationId: null });
        }
